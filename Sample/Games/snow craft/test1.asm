...
load_heart macro heart
	...
	cmp heart,1
	jb h1
	showpicture 150,181,15,13,heart
	cmp heart,2
	jb h1
	showpicture 165,181,15,13,heart
	cmp heart,3
	jb h1
	showpicture 180,181,15,13,heart
h1:	
...
load_screen macro
	...
	showmessage 20,23,mesg11  ; lift 
	showmessage 60,23,mesg10  ; score
